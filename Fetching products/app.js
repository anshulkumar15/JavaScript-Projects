(async ()=>{
	const productContainerEl=document.getElementById("productsContainer");
...
const genetrateProducts=(product)=>{
...
const renderProducts=(products)=>{
	...
	products.forEach((product)=>{
		productContainerEl.innerHTML+=genetrateProducts(product);
	});
};
...
searchInputElEl.addEventListener("keyup",filterHandler)
